...
```{r census setup, echo=FALSE, warning = FALSE}
...
```{r education setup, echo=FALSE, warning = FALSE}
...
# Modeling
```{r, 14 v1 , echo=FALSE, warning = FALSE}
...
```{r 14 v2 , echo=FALSE, warning = FALSE}
...
### Lasso
```{r 17 2nd , echo=FALSE, warning = FALSE}
library(glmnet)
set.seed(123)
...
### KNN
```{r 19KNN , echo=FALSE, warning = FALSE}
...
### Random Forest
```{r 19randomForest , echo=FALSE, warning = FALSE}
set.seed(123)
# Installing package
